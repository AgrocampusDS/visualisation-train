...
Depart <- carte + 
  ...
  labs(title = "Proportion de retard selon la zone géographique",color = "Trains en retard au départ (en %)", caption = "Période : janvier 2015 à juin 2020") +
...
Arrivee <- carte + 
  ...
  scale_size_continuous(name = "Nombre total de trains", range = c(1,5), labels = c("200000","300000","400000","500000","600000"))+
  labs(title = "Proportion de retard selon la zone géographique", color = "Trains en retard à l'arrivée (en %)", caption = "Période : janvier 2015 à juin 2020" ) +
