...
Depart <- carte + 
  ...
  geom_text(aes(x = Final_train$Longitude, y = Final_train$Latitude) ,label = rownames(Final_train), nudge_x = 0, nudge_y = c(-0.05,-0.05,-0.03,-0.03,0.02), fontface = 2, color = c("white","white","black","black","black"))
